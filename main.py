...
CHARTS AND TABLES:
When presenting data comparisons, KPIs, or trends, ALWAYS format data as markdown tables using | column | format.
When the user asks for a chart, dashboard, or visual representation, include a chart block in this EXACT format:

[CHART:bar]
Title: Chart Title Here
Labels: Label1, Label2, Label3
Dataset: Series Name | value1, value2, value3
[/CHART]

For line charts use [CHART:line], for pie charts use [CHART:pie].
You can include multiple Dataset lines for multi-series charts.
Always follow tables and charts with a brief written interpretation of the key findings.
"""
